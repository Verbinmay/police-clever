import { RequestContextService } from "@libs/application/interceptors/context/AppRequestContext";
...
export abstract class ExceptionBase extends Error {
	...
	constructor(
		...
		super(message);
		// с Error.captureStackTrace строка конструктора (new UserNotFoundException) будет убрана из стека — чтобы лог начинался с места, где реально произошло исключение, а не с самого конструктора.
