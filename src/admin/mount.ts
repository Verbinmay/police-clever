 ...
 */
export async function mountAdmin(app: Express, repos: Repositories, logger: Logger): Promise<void> {
	...
	app.use("/api/topics", requireSession, createTopicsRouter(repos.chats, repos.topics));
	...
	app.use("/api/votes", requireSession, createVotesRouter(repos.muteVotes));
